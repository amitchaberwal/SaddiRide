...
import 'package:saddiride/Pages/Login/SignUpA.dart';
...
class Splash extends StatelessWidget {
  Future getPage(BuildContext context) async{
    ...
    if(user != null){
      ...
      var muser = await FirebaseFirestore.instance.collection('User').doc(mphone).collection('Account').doc('Profile').get();
      if(muser.exists){
