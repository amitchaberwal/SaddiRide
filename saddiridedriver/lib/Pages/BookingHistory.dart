...
class _BookingHistoryState extends State<BookingHistory> {
  ...
  getProducts() async {
    ...
    Query quary;
    quary = FirebaseFirestore.instance.collection('Driver').doc(FirebaseAuth.instance.currentUser.phoneNumber).collection('Booking').where('Status',whereIn: ['Completed','Cancelled']).orderBy('BookTimeStamp',descending: true);
